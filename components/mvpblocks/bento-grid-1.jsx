...
const items = [
  {
    ...
    description:
      "A refined and premium digital experience crafted with Monalux design philosophy.",
  ...
  },
  {
    ...
    description:
      "Built with accessibility-first standards to ensure inclusive experiences by Monalux.",
  ...
  },
  {
    ...
    description:
      "Fluid and adaptive layouts across all devices, designed by Monalux.",
    icon: <Layers className="size-6" />,
    size: "medium",
  },
  {
    ...
    description:
      "Highly customizable websites aligned with your brand, powered by Monalux.",
  ...
  },
  {
    ...
    description:
      "Fast, efficient, and scalable performance as a core standard of Monalux.",
  ...
  },
  {
    ...
    description:
      "Clear and well-organized documentation to accelerate workflows with Monalux.",
...
export default function BentoGrid1() {
  ...
  return (
    <div className="bg-black mx-auto w-full px-4 py-12">
      <motion.div
